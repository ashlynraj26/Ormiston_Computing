...
###################################################### Button command to difficulty selection page:######################################
    ...
    #widgets
        ...
        self.b3=Button(self.f2,text="MEDIUM", width=14, height=7, highlightbackground="orange", command=self.medqpage)
...
################################################################# Easy questions page: ##########################################################################
    ...
    #widgets
         ...
         self.solving.place(y=90,x=360, height=75, width=100)
...
#solving Entry (solving =Entry(f3)) for the easy questions
    ...
    def submt(self, solving): 
        ...
        if self.solving.get() == str(self.resulteasyq()):
            self.correct = Label(text="CORRECT", fg="green", font=("helvetica", 40), bg="#E0FFFF")
            self.correct.place(x=460, y=120)
           ...
           self.wrong = Label(text="WRONG", fg="red", font=("helvetica", 40), bg="#E0FFFF")
           self.wrong.place(x=460, y=120)
           self.submit.config(state=DISABLED)
           self.solving.config(state=DISABLED)
           count = count+1
...
#Displays the math question by selecting two random values from the "num" list 
    ...
    def nextq_easy(self):
         ...
         self.question = Label(text=f"{self.nextq_easy.easyq1update}+{self.nextq_easy.easyq2update}=", font = "Helvetica 60 bold",bg="#E0FFFF")
         self.question.place(y=87, x=150)
